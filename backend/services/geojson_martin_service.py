...
class GeoJsonMartinService:
    ...
    def _record_to_database(self, file_id, original_filename, file_path, analysis, postgis_result, user_id):
        ...
        try:
            ...
            # 构建MVT和TileJSON URL
            mvt_url = f"http://localhost:3000/public.{table_name}/{{z}}/{{x}}/{{y}}.pbf"
            tilejson_url = f"http://localhost:3000/public.{table_name}"
            ...
            params = (
                ...
                file_path,
                table_name,
                f"http://localhost:3000/public.{table_name}",  # service_url
                mvt_url,
                tilejson_url,
